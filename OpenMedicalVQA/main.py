...
def parse_argument():
    ...
    parser.add_argument("--data_partition", type=str, default="default_partition")
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--epochs", type=int, default=30)
    parser.add_argument("--dataset", type=str, default='slake', choices=('slake'))
...
if __name__ == "__main__":
  ...
  train_dataset = medvqaDataset(args.dataset_path + args.dataset+'/',split='train', prefix_length=args.prefix_length, model_type=args.model_type, setting=args.setting)
  val_dataset = medvqaDataset(args.dataset_path+args.dataset+'/',split="val",prefix_length=args.prefix_length,model_type=args.model_type,setting = args.setting)
  ...
  if not args.eval:
    ...
    if args.verbose:
      print(f">>laoding pre-trained model {checkpoint}!")
